  ...
  return (
    <div className="flex h-full w-full flex-col gap-6">
      ...
      <uploadImageFetcher.Form
        ...
        <div className="flex w-full items-start justify-between gap-1 rounded-lg p-6">
          ...
          <label
            ...
            className="group relative flex min-w-12 cursor-pointer overflow-hidden rounded-full transition active:scale-95">
            {imageSrc || user.image?.id ? (
              ...
              <div className="h-12 w-12 rounded-full bg-gradient-to-br from-lime-400 from-10% via-cyan-300 to-blue-500 md:h-20 md:w-20" />
            )}
